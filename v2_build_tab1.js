            ...
            <div class="dashboard-tab block" id="panel-dashboard">
                ...
                <div class="bg-black-light border border-white/5 rounded-xl p-6 mb-8 flex items-center gap-6 w-full md:w-max max-w-full shadow-lg">
                    ...
                    <div class="flex flex-col">
                        <h4 class="text-white text-xl md:text-2xl font-bold flex flex-wrap items-baseline gap-2">
                            <span class="display-user-name font-serif">Director Omega</span>
                            <span class="text-gray-400 text-sm md:text-base font-light display-user-email">cmd@stackly.agency</span>
                        </h4>
                        <span class="text-gold text-sm mt-1 display-user-role tracking-widest uppercase">Global Command Center</span>
                    </div>
                </div>
